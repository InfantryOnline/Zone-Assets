...
{   // Script Class
    ...
    ///////////////////////////////////////////////////////
    public partial class Juggernaut : Bot
    {   ///////////////////////////////////////////////////
        // Member Variables
        ///////////////////////////////////////////////////
        ...
        private int _tickSpawned;
        private int _tickLastRadarDot;
        public static ushort basevehicleID = 181;
        public static ushort vetvehicleID = 181;
        public static ushort adeptvehicleID = 181;
        ...
        {   //Dead? Do nothing
            ...
            if (now - _tickSpawned >= 120000 && _tickSpawned != 0)
            {
                _team.sendArenaMessage("&Juggernaut> Looks like it's time to leave with a bang!", 4);
                destroy(true);
            }
            ...
            if (target != null)
            {
                bAttacking = true;
                //Too far?
                if (Helpers.distanceTo(this, target) > 60)
                {
                    steering.bSkipRotate = false;
                    steering.steerDelegate = steerForSeekTarget;
                }
                //Too short?
                else if (Helpers.distanceTo(this, target) < 10)
                {
                    bBackPedal = true;
            ...
            if (!bAttacking && Helpers.distanceTo(_creator._state, _state) > 100)
                followPlayer(now);
