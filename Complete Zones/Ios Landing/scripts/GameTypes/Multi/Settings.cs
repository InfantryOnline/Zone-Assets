...
namespace InfServer.Script.GameType_Multi
{
    public abstract class Settings
    {
        ...
        public const int c_DifficultyBonus_Fixed = 8000;
        public const int c_jackpot_Co_PointsPerKill = 3;
        public const int c_jackpot_Co_PointsPerDeath = 4;
        public const int c_jackpot_Co_PointsPerFlag = 8;
        ...
        //Difficulty
        public const double c_difficulty_CashMultiplier = 0.45;
        public const double c_difficulty_ExpMultiplier = 0.35;
        public const double c_difficulty_PtsMultiplier = 0.45;
